...
/* 1. @Component = ele é o próprio componente em si.
*  2. return email = o email por fim retornará todas as propriedades necessárias para o envio de email
*  3. Thread.sleep(2000) = intervalo de 2 segundos de um email para o outro */
